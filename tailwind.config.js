  ...
  theme: {
    extend: {
      ...
      backgroundImage: (theme) => ({
        ...
        'icon-facebook': "url('../images/png/common/sns_facebook.png')",
        'icon-twitter': "url('../images/png/common/sns_twitter.png')",
        'icon-instagram': "url('../images/png/common/sns_instagram.png')",
        'icon-blog': "url('../images/png/common/sns_blog.png')",
        'icon-youtube': "url('../images/png/common/sns_youtube.png')",
